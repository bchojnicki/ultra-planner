...
- **When** they enter their email address and submit for the first time
- **Then** they see a "check your email" confirmation screen; clicking the magic link in the email creates their account and takes them to the plan dashboard

#### Acceptance Criteria
- The form requires email only — no password field exists
- After submission, the app navigates to a confirmation screen; it does not show an inline message
- Clicking the magic link creates the runner's account on first use and redirects to the dashboard
...
- **When** they enter their email address and submit on the sign-in screen
- **Then** they see a "check your email" confirmation screen; clicking the magic link in the email authenticates them and takes them to the plan dashboard

#### Acceptance Criteria
- The sign-in and registration flows share the same screen and the same "check your email" confirmation step
- Clicking the magic link authenticates the runner and redirects them to the dashboard
