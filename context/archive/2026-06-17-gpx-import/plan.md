...
- [x] 3.4 Import replaces stations + sets plan values; 403/404 paths verified — a7c9628
...
- [x] 5.1 E2E passes (`npx playwright test tests/gpx-import.spec.ts`) — 3401841
- [x] 5.2 Type checking passes (`npx astro sync && npm run build`) — f21fe43
- [x] 5.3 Linting passes (`npm run lint`) — f21fe43

#### Manual

- [x] 5.4 Upload populates details + stations; confirm-overwrite works; bad file errors — f21fe43
- [x] 5.5 Editing a total live-rescales segments — f21fe43
- [x] 5.6 Manual loss field persists and shows in the table — f21fe43
